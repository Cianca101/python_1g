...
class BranchOffice(models.Model):
    ...
    # Relations
    # number_date = models.ForeignKey(PetDate, on_delete=models.PROTECT, related_name="offices")

    def __str__(self):
        return f"{self.alias}, {self.address}, {self.phone},"
...
class PetDate(models.Model):
    ...
    office = models.ForeignKey(BranchOffice, on_delete=models.PROTECT, related_name="dates", null=True)
